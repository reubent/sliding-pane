...
import './index.css';
export var CLOSE_TIMEOUT = 500;
export var ReactSlidingPane = function (_a) {
    ...
    return (React.createElement(Modal, { className: 'slide-pane '
            ...
            .concat(className || ''), style: { content: { width: width || '80%' } }, overlayClassName: 'slide-pane__overlay '.concat(overlayClassName || ''), closeTimeoutMS: CLOSE_TIMEOUT, isOpen: isOpen, shouldCloseOnEsc: shouldCloseOnEsc, onAfterOpen: onAfterOpen, onRequestClose: onRequestClose, contentLabel: 'Modal "'.concat(title || '', '"') },
